 ...
 * on DB level. See <a href="https://www.sqlite.org/lang_createtable.html">here</a> for more
 * information.
 * </p>
 *
 * @see Index#unique()
 */
@Retention(RetentionPolicy.SOURCE) @Target(ElementType.FIELD) public @interface Unique {
}
