...
/**
 * APIs annotated with @Beta may change and may be even removed in a future release (but is somewhat
 * less likely
 * compared to {@link Experimental}). You can still use this API - just be aware that a future
 * version may require
...
@Retention(RetentionPolicy.CLASS) @Target({
    ...
    ElementType.TYPE
}) @Documented public @interface Beta {
}
