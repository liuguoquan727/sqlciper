 ...
 * @see Entity#indexes()
 */
@Retention(RetentionPolicy.SOURCE) @Target(ElementType.FIELD) public @interface Index {
  /**
   ...
   * If omitted, then generated automatically by greenDAO with base on property/properties column
   * name(s)
   */
  String name() default "";
