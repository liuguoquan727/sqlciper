 ...
 * </p>
 * <p>
 * Don't use this annotation on a class member if you are not completely sure what you are doing,
 * because in
 * case of model changes greenDAO will not be able to make corresponding changes into the code of
 * the target.
 * </p>
 *
 * @see Generated
