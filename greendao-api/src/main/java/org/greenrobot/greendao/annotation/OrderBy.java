 ...
 */
@Retention(RetentionPolicy.SOURCE) @Target(ElementType.FIELD) public @interface OrderBy {
  /**
   * Comma-separated list of properties, e.g. "propertyA, propertyB, propertyC"
   * To specify direction, add ASC or DESC after property name, e.g.: "propertyA DESC, propertyB
   * ASC"
