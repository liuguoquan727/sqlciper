...
public class IdentityScopeLong<T> implements IdentityScope<Long, T> {
  ...
  @Override public T getNoLock(Long key) {
  ...
  @Override public void put(Long key, T entity) {
    put2(key, entity);
  }

  @Override public void putNoLock(Long key, T entity) {
  ...
  @Override public boolean detach(Long key, T entity) {
    lock.lock();
    try {
  ...
  @Override public void remove(Iterable<Long> keys) {
    lock.lock();
    try {
      for (Long key : keys) {
        map.remove(key);
