...
public class AsyncOperation {
  ...
  AsyncOperation(OperationType type, AbstractDao<?, ?> dao, SQLiteDatabase database,
    ...
    creatorStacktrace = (flags & FLAG_TRACK_CREATOR_STACKTRACE) != 0 ? new Exception(
        "AsyncOperation was created here") : null;
  }
  ...
  /**
   * @return true if this operation is mergeable with the given operation. Checks for null, {@link
   * #FLAG_MERGE_TX},
  ...
  /**
   * Waits until the operation is complete. If the thread gets interrupted, any {@link
   * InterruptedException} will be
  ...
  /**
   * Called when the operation is done. Notifies any threads waiting for this operation's
   * completion.
   */
  ...
  /**
   * If this operation was successfully merged with other operation into a single TX, this will give
   * the count of
  ...
  /**
   * Each operation get a unique sequence number when the operation is enqueued. Can be used for
   * efficiently
  ...
  /**
   * The stacktrace is captured using an exception if {@link #FLAG_TRACK_CREATOR_STACKTRACE} was
   * used (null
   * otherwise).
   */
