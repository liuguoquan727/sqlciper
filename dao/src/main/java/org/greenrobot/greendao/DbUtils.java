...
public class DbUtils {
  ...
  /**
   * Calls {@link #executeSqlScript(Context, Database, String, boolean)} with transactional set to
   * true.
   *
   ...
   * file may contain
   * multiple SQL statements. Statements are split using a simple regular expression (something
   * like
   * "semicolon before a line break"), not by analyzing the SQL syntax. This will work for many SQL
   * files, but check
   * yours.
   *
   * @return number of statements executed.
