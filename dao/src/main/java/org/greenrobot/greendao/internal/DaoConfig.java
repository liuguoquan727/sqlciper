...
/**
 * Internal class used by greenDAO. DaoConfig stores essential data for DAOs, and is hold by
 * AbstractDaoMaster. This
...
public final class DaoConfig implements Cloneable {
  ...
  /** Does not copy identity scope. */
  @Override public DaoConfig clone() {
  ...
  @SuppressWarnings("rawtypes") public void initIdentityScope(IdentityScopeType type) {
