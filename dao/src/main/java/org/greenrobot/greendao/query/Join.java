...
/**
 * A Join lets you relate to other entity types for queries, and allows using WHERE statements on
 * the joined entity
 * type.
 */
public class Join<SRC, DST> {
   ...
   * given in the generated dao classes.
   */
  public Join<SRC, DST> whereOr(WhereCondition cond1, WhereCondition cond2,
   ...
   * {@link org.greenrobot.greendao.query.WhereCondition.StringCondition} into the query, this value
   * allows to reference
